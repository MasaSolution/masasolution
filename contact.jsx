        ...
        return (
            <div className="fixed-bottom card text-center">
                ...
                <div className="card-body">
                    ...
                    <p className="card-text">If you like our products</p>
                    <p className="card-text">If you want a solution that nobody has</p>
                    <p className="card-text">Drop an email and we will contact to you</p>
                </div>
            </div>
        );
    }
